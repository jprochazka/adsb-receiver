...
PORTAL_BACKEND_VERSION_DEFAULT="v3.0.0"
PORTAL_API_DOCS_ENABLED_DEFAULT="true"
PORTAL_CORS_ORIGINS_DEFAULT=""
...
PORTAL_BACKEND_VERSION="${PORTAL_BACKEND_VERSION_DEFAULT}"
PORTAL_API_DOCS_ENABLED="${PORTAL_API_DOCS_ENABLED_DEFAULT}"
PORTAL_CORS_ORIGINS="${PORTAL_CORS_ORIGINS_DEFAULT}"
RRD_MIGRATE_SOURCE=""
...
Environment="PORTAL_BACKEND_VERSION=${PORTAL_BACKEND_VERSION}"
Environment="PORTAL_API_DOCS_ENABLED=${PORTAL_API_DOCS_ENABLED}"
Environment="PORTAL_CORS_ORIGINS=${PORTAL_CORS_ORIGINS}"
